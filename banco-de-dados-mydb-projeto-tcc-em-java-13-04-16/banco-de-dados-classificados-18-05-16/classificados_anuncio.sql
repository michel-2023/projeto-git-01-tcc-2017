...
CREATE TABLE `anuncio` (
  ...
  CONSTRAINT `fk_anuncio_categoria1` FOREIGN KEY (`cat_cod`) REFERENCES `categoria` (`cat_cod`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_anuncio_pessoa1` FOREIGN KEY (`us_cod`) REFERENCES `pessoa` (`us_cod`) ON DELETE NO ACTION ON UPDATE NO ACTION
